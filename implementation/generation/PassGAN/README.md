...
- A command-line interface `sample.py` `train.py` with the commands used for each password managers in commands.txt
- Models trained on 5 train/test split of passwords from 7 password managers using PassGAN. The trained models can be found on OneDrive [here](https://durhamuniversity-my.sharepoint.com/:f:/g/personal/rpsh88_durham_ac_uk/EgUo4pMuNCdDv-aIE8CMT4MB9DUCt2avD0AeWNN7vGaVjw?e=jgRE0e) (12.5 GB). 
- Please do not hesitate to contact me if there are any difficulties accessing the folder. 
